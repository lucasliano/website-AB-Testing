...
from ..deps import templates, common_context
...
def universities(request: Request):
    ...
    return templates.TemplateResponse("universities.html", ctx)

@router.get("/documentation")
def documentation(request: Request):
    ctx = common_context(request, title="RF Analyzer - Documentation")
    return templates.TemplateResponse("documentation.html", ctx)
